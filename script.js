    ...
    .then(data => {
      if (data.cod === 200) {
        ...
        if (isDaytime) {
            ...
            weatherIcon.innerHTML = `<img src="\Downloads\sun.png" alt="Day weather icon">`;  // Replace with your day image link
          } else {
            document.body.classList.remove("light-theme");
            document.body.classList.add("dark-theme");
            weatherIcon.innerHTML = `<img src="\Downloads\moon.png" alt="Night weather icon">`;  // Replace with your night image link
        }
      } else {
